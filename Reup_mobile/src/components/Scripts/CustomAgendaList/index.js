...
export default class AgendaView extends Component {
  ...
  static propTypes = {
    ...
    /** Called when need to use Custom Reservation **/
    useCustomReservation: PropTypes.bool
  };
  ...
  chooseDay(d, optimisticScroll) {
    ...
    if(!this.props.useCustomReservation) {
  ...
  render() {
    if(this.props.useCustomReservation) {
      return this.renderCustomReservations();
    }
