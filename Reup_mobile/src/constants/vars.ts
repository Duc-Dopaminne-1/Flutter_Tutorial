// Color system
import { ColorPropType, Dimensions, Platform } from 'react-native';
...
export const colors = {
  ...
  TEXT_SMALL_RED: '#FF0C0C',
  INPUT_BG: '#ffffff',

  DARK_GRAY: '#333333',
  WHITE_LIGHT: '#F9F9FC',
  BOOK_IMAGE_LIGHT: 'rgba(0, 0, 0, 0)',
  BOOK_IMAGE_DARK: 'rgba(0, 0, 0, 0.9)',

  SLIDER_LIGHT: 'rgba(216, 216, 216, 0)',
  SLIDER_DARK: 'rgba(216, 216, 216, 0.9)',

  SIDE_MENU: {
    HEADER_BACKGROUND_COLOR: '#1B72BF',
  },

  AVATAR_DEFAULT: '#E4E4E4',
  GREEN_BUTTON: '#1FA207',
};
...
export const WIDTH_GENRES = Dimensions.get('window').width;
export const INPUT_WIDTH = WIDTH * 0.93;

export const WIDTH_RATIO = WIDTH > 375 ? 1 : WIDTH / 375;
export const HEIGHT_RATIO = HEIGHT > 812 ? 1 : HEIGHT / 812;
export const BOTTOM_TAB_HEIGHT = !isAndroid() && HEIGHT >= 812 ? 85 : 65 * WIDTH_RATIO;
...
// regex format
export const REGEX_PROMO_CODE = /^[A-Z0-9]*$/;
export const REGEX_POSTAL_CODE_CAD = /^[A-Z0-9][A-Z0-9\- ]{0,10}[A-Z0-9]$/;

export const weekDays = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
export const tableWeekDays = ['', 'Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
...
export const fonts = {
  ...
  MontserratExtraLight: 'Montserrat-Montserrat-ExtraLight',
...
export const LimitLoadMore = Config.Manager.limitPage;
export const LimitGetAll = Config.Manager.limitGetAll;
export const LimitItemForLeaseForSaleAtHome = 4;
