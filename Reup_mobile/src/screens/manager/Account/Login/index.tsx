...
import { SIGN_UP, FORGOT_PASSWORD, MAIN_SCREEN, CONFIRMATION, PERSONAL_INFO } from '@constants/screenKeys';
...
const Login = (props: any) => {
  ...
  const detectNavigationLoginScreen = (isUpdatedProfile: boolean, isInvited: boolean) => {
    ...
    if (isUpdatedProfile) {
      ...
      NavigationActionsService.push(PERSONAL_INFO);
    }
  }
        ...
        <ImageBackground source={BG_SIGNIN} style={styles.logo} resizeMode={'stretch'}>
          ...
          >
            <View style={styles.content}>
              ...
              <CustomText style={styles.headerTitle} text={translate('authentication.signin_l  abel')} />
              {renderInputFields()}
              {renderSocialButton()}
