...
import { EditType } from '../MyProfile';
...
const EditProfile = (props: Props) => {
  ...
  const [dateStart, setDateStart] = useState(me && me.date_of_birth ? formatDateWith(me.date_of_birth, Config.Manager.formatDate, Config.Manager.formatDate) : getToday());
  const initialValuePersonal = {
    firstName: me && me.first_name ? me.first_name : '',
    lastName: me && me.last_name ? me.last_name : '',
    dob: me && me.date_of_birth ? formatDateWith(me.date_of_birth, Config.Manager.formatDateDisplay, Config.Manager.formatDate) : '',
  ...
  const onSubmitEditProfile = (values: any, actions: any) => {
    Keyboard.dismiss();
    let dataProfile = {};
    if (typeEdit == EditType.PERSONAL) {
      dataProfile = {
        ...
        date_of_birth: formatDateWith(values.dob, Config.Manager.formatDate, Config.Manager.formatDateDisplay),
