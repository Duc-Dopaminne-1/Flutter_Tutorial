...
import MaintenanceReportItem from '@screens/manager/MaintenanceReports/Modal/Items/Item';
import { CustomButton } from '@components/CustomButton';
import translate from '@src/localize';
import styles from '@screens/manager/MaintenanceReports/Modal/styles';
...
const MaintenanceReportModal = (prop: Props) => {
...
export default React.memo(MaintenanceReportModal);
