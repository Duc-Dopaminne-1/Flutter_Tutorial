...
import { LOGIN_TENANT } from '@src/constants/screenKeys';

interface Props {

}
const ResetPasswordSuccessTenant = (props: Props) => {

  const onBack = () => {
    NavigationActionsService.push(LOGIN_TENANT);
  };
...
export default ResetPasswordSuccessTenant;
