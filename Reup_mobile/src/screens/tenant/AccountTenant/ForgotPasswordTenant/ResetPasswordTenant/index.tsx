...
import { RESET_PASSWORD_SUCCESS_TENANT } from '@src/constants/screenKeys';
...
const ResetPasswordTenant = (props: Props) => {
    ...
    dispatch(
      confirmOTP({
        ...
        onSuccess: () => {
          ...
          setTimeout(() => {
            setLoading(false);
            NavigationActionsService.push(RESET_PASSWORD_SUCCESS_TENANT);
          }, 700);
        },
        onFail: error => {
          Keyboard.dismiss();
