...
const FilterTenant = (props: Props) => {
  ...
  const fetchListApartmentTenant = () => {
    NavigationActionsService.showLoading()
    dispatch(
      getUnitListMe({
        page: 1,
  ...
  useEffect(() => {
    isApartment && fetchListApartmentTenant()
          ...
          <View style={[styles.listContainer, !isAndroid() ? { paddingBottom: paddingBottom } : {}]}>
            <ScrollView style={styles.containerScrollView}>
              <View style={styles.inputFormSubContainer}>
                ...
                {/* {isCountry ? renderCountry(formikProps) : null}
...
export default React.memo(FilterTenant);
