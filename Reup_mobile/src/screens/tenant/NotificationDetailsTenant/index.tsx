...
import { getUserName, formatTime, isManagerApp } from '@src/utils';
...
const NotificationDetailsTenant = () => {
  ...
  return (
    <Container isDisplayNotification={false}
      ...
      <View style={styles.container}>
        ...
        {isManagerApp() && renderBottomComponent()}
      </View>
    </Container >
  );
};

export default NotificationDetailsTenant;
