...
export default class Swipeable extends PureComponent<any, any> {
  ...
  constructor(props) {
    ...
    this._onGestureEvent = Animated.event([{ nativeEvent: { translationX: dragX } }], { useNativeDriver: props.useNativeAnimations });
  }
  ...
  _updateAnimatedEvent = (props: any, state: any) => {
    const { friction, overshootFriction, widthSwipeRight } = props;
  ...
  render() {
    ...
    const left = renderLeftActions && (
      <Animated.View style={[styles.leftActions, { transform: [{ translateX: this._leftActionTranslate }] }]}>
    ...
    const right = renderRightActions && (
      <Animated.View style={[styles.rightActions, { transform: [{ translateX: this._rightActionTranslate }] }]}>
    ...
    return (
      <PanGestureHandler
        {...this.props}
        minDeltaX={10}
        onGestureEvent={isSwipe ? this._onGestureEventHide : this._onGestureEvent}
        onHandlerStateChange={isSwipe ? this._onHandlerStateChangeHide : this._onHandlerStateChange}
      >
        <Animated.View onLayout={this._onRowLayout} style={[styles.container, this.props.containerStyle]}>
          ...
          <TapGestureHandler
            enabled={rowState !== 0}
            onHandlerStateChange={isSwipe ? this._onTapHandlerStateChangeHide : this._onTapHandlerStateChange}
          >
            <Animated.View
