...
export default function MeetAndGreetEndDialog(props: Props): ReactElement {
  const { isVisible, onBackdropPress = () => {} } = props;

  return (
    <Modal onBackdropPress={() => {}} onBackButtonPress={onBackdropPress} isVisible={isVisible} style={styles.wrapModal}>
      <View style={styles.container}>
        ...
        <View style={styles.contentView}>
          {/* Title */}
          <DefaultText {...{ style: styles.title }}>{language('meetAndGreetEnd')}</DefaultText>
