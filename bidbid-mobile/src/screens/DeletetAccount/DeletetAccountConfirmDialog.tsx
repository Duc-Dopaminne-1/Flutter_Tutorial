...
export default function DeletetAccountConfirmDialog(props: Props): ReactElement {
    ...
    <Modal onBackdropPress={onBackdropPress} onBackButtonPress={onBackdropPress} isVisible={isVisible} style={styles.wrapModal}>
      <View style={styles.container}>
        ...
        <View style={styles.contentView}>
          <Text style={styles.description}>{language('deleteAccountReasonScreen.deleteConfirm')}</Text>
        </View>
