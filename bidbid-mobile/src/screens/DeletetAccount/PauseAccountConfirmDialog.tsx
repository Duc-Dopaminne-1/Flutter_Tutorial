...
export default function PauseAccountConfirmDialog(props: Props): ReactElement {
  ...
  const description = isUserPaused(pauses)
    ? language('deleteAccountScreen.unPauseAccountConfirm')
    : language('deleteAccountScreen.pauseAccountConfirm');
