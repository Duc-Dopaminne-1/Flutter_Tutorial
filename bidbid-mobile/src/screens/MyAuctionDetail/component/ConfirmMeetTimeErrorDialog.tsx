...
export default function ConfirmMeetTimeErrorDialog(props: Props): ReactElement {
  const { isVisible, onBackdropPress = () => {}, textError } = props;
    ...
    <Modal onBackdropPress={onBackdropPress} onBackButtonPress={onBackdropPress} isVisible={isVisible} style={styles.wrapModal}>
      <View style={styles.container}>
        ...
        <View style={styles.contentView}>
          ...
          {/* Description */}
          <DefaultText {...{ style: styles.textStyle }}>{textError}</DefaultText>
