...
export default function SafetyScreen(): ReactElement {
  const uri = useSelector((state: AppInit) => state.app.setting.FILE_SAFETY_POLICY);
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.wrapperHeader}>
        <CustomHeader titleStyle={styles.titleText} title={language('safetyScreen.title')} leftIcon={<IconBack />} />
      </View>
