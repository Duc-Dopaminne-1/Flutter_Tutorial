...
export default function TermOfServiceScreen(): ReactElement {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.wrapperHeader}>
        <CustomHeader titleStyle={styles.titleText} title={language('termOfServiceScreen.title')} leftIcon={<IconBack />} />
      </View>
