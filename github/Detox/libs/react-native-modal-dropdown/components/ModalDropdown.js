...
export default class ModalDropdown extends Component {
  ...
  _renderRow = (item,index, sectionID, highlightRow) => {
    ...
    const preservedProps = {
      key,
      accessible,
      onPress: () => this._onRowPress(item, sectionID, index, highlightRow),
    };
  ...
  _onRowPress(item, sectionID, index, highlightRow) {
