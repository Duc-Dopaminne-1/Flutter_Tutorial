...
import SwipeButtonsContainer from './swiperButton';
...
export default class SwipeItem extends React.Component<Props, States> {
  ...
  render() {
    ...
    const { swipeContainerStyle, containerView: ContainerView = View} = this.props;

    return (
        <ContainerView style={[containerStyles.rootContainer]}>
