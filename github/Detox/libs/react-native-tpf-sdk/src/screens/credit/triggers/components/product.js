import { ICCoin, ICHotMix, ICNewProduct } from '../../../../assets/icons';
...
const CreditProduct = props => {
  ...
  return (
    <TouchableOpacity
      ...
      <>
        {isHot ? <ICHotMix style={styles.newContainer} color1={theme?.app?.primaryColor1} /> : null}
      </>
      ...
      <View style={[styles.container, fullWidth && styles.fullWidth, style]}>
        ...
        <View style={styles.contentContainer}>
          <BodyText numberOfLines={1} semiBold style={styles.name}>
            {item?.name || ''}
          </BodyText>
          ...
          <View style={styles.priceContainer}>
            <ICCoin color1={theme?.icon?.color1} />
            <AppText
              translate
              semiBold
              style={[styles.price, { color: theme?.app?.primaryColor1 }]}
              numberOfLines={1}>
