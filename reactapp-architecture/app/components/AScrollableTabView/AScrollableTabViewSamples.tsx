...
export class AScrollableTabViewSamples extends React.PureComponent<
...
> {
  ...
  componentDidMount() {
    this._subscription = scrollTabViewSample.subscribe(data => {
  ...
  get searchKeywordType() {
    ...
    if (indexTab === 0) {
      return SearchKeywordType.AssignedToMeSamples
    }
    if (indexTab === 1) {
      return SearchKeywordType.MySamples
    }
    if (indexTab === 2) {
