...
> {
  ...
  _createButton = (titles, index) => {
    ...
    const indexArchive = index === lastItem ? { borderBottomWidth: 0 } : {}

    const topBorder = index === 0 ? { borderTopWidth: 1 } : {}
      ...
      >
        <View style={[styles.wrapper]}>
          ...
          <Animated.View
            style={[
              styles.body,
              { margin: 10, borderColor: '#fff', borderRadius: 12 },
              {
...
const styles2 = StyleSheet.create({
  ...
  buttonBox: {
    height: 50,
    borderBottomWidth: 1,
    borderColor: colors.light_white_gray,
    alignItems: 'center',
    justifyContent: 'center',
  },
  buttonText: {
