import { Category, Project } from '@/models/team'
...
export class SelectProjectSuggestList extends React.Component<Props> {
  ...
  renderFooter = () => {
    return (
      <AText1
        title={I18n.t('allProjects').toUpperCase()}
  ...
  render() {
    const { suggestProject } = this.props

    if (suggestProject.length <= 0) return null
