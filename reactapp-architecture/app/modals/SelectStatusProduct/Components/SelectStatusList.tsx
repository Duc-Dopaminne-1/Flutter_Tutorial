...
import { ProductStatus } from '@/models/team'
...
type SelectStatusListProps = {
  keyword: string
  onPress: (item: ProductStatus) => void
  data: Realm.Collection<ProductStatus>
  onClose?: () => void
  flatListRef?: any
  flatListProps?: Partial<FlatListProps<ProductStatus>>
}

export class SelectStatusListProduct extends React.PureComponent<
...
> {
  ...
  renderItem = ({ item }) => {
    ...
    const name = SafeStatusType.getName(statusName)
