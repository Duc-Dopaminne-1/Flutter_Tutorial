...
import { SampleQuery } from '@/screens/Sample/SampleQuery'
...
export class ProductInfoActivitySamples extends React.PureComponent<Props> {
  onTaskAction = () => {}
...
const styles = StyleSheet.create({
  container: {
    ...
    marginTop: 12,
    paddingBottom: !isIphoneX() ? 24 : 0, // Sample component already has bootm padding for iPhoneX devices
  },
  header: {
    flexDirection: 'row',
